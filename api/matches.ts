...
"Sevlievo": "세블리에보",
  ...
  "Amed": "아메드",
  "İstanbulspor": "이스탄불스포르",
  "Erzurumspor FK": "에르주룸스포르", "Larisa": "라리사",
  "FC Porto B": "포르투 B",
  ...
  "Platense": "플라텐세",
  "Penarol": "페냐롤", "Lokeren-Temse": "로케런-템세",
  "Étoile Carouge": "에투알 카루주",
  "Yverdon Sport": "이버돈 스포르트",
  "Odra Opole": "오드라 오폴레",
  "Seraing United": "세랭 유나이티드",
  "Jagiellonia": "야기엘로니아",
  "Puszcza Niepołomice": "푸슈차 니에폴로미체",
  "FC Augsburg": "아우크스부르크",
  ...
  "Loudoun United": "라우던 유나이티드",
  "Louisville City": "루이빌 시티",
  "Botafogo SP": "보타포구 SP",
  "Belgrano Cordoba": "벨그라노 코르도바",
  "Aldosivi": "알도시비",
  "Alebrijes de Oaxaca": "알레브리헤스 데 오아하카",
  "CDS Tampico Madero": "탐피코 마데로",
  "CA La Paz": "라 파스",
  "Tepatitlán": "테파티틀란",
  ...
  "Qingdao Youth Island": "칭다오 유스 아일랜드",
  "Shenyang Urban": "선양 어반",
  "Guangzhou E-Power": "광저우 E-파워",
  "Wuxi Wugou": "우시 우거우",
  "Meizhou Kejia": "메이저우 커자",
  "Guangxi Hengchen": "광시 헝천",
  "Henan Jianye": "허난 젠예",
  "Shandong Luneng": "산둥 루넝",
  "SHANGHAI SIPG": "상하이 SIPG",
  "Monaro Panthers": "모나로 팬서스",
  "Tuggeranong United": "터거라농 유나이티드",
  "Queanbeyan City": "퀸비언 시티",
  "Canberra Juventus": "캔버라 유벤투스",
  "Belconnen United": "벨코넨 유나이티드",
  "Cooma Tigers FC": "쿠마 타이거스",
  "Canberra White Eagles": "캔버라 화이트 이글스",
  "Sydney": "시드니",
  "Sarıyer": "사르예르",
  "Hillerød": "힐레뢰드",
  "AC Horsens": "호르센스",
  ...
  "Austria Salzburg": "아우스트리아 잘츠부르크",
  "FC Liefering": "리퍼링",
  "Floridsdorfer AC": "플로리츠도르퍼",
  "Lyngby": "링비",
  "Kolding IF": "콜딩",
  "Widzew Łódź": "비제프 우치",
  "Nieciecza": "니에치에차",
  "Hellas Verona": "엘라스 베로나",
  "Sporting CP B": "스포르팅 B",
  "Çorum FK": "초룸 FK",
  "Virtus Entella": "비르투스 엔텔라",
  "Pescara": "페스카라",
  "Kazincbarcikai": "카진크바르치카이",
  ...
  "Charlton": "찰턴",
  "RSC Anderlecht II": "안데를레흐트 2군",
  "Budafoki LC": "부다포키",
  "Mezokovesd-zsory": "메조쾨베슈드",
  "Szeged 2011": "세게드",
  "Szentlörinc SE": "센틀뢰린츠",
  "Vasas": "바사시",
