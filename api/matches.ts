...
const teamNameMap: { [key: string]: string } = {
  ...
  // 분데스리가
  "Augsburg": "아우크스부르크", "Bayer Leverkusen": "레버쿠젠", "Bayern München": "바이에른 뮌헨", "Borussia Dortmund": "도르트문트", "Borussia Monchengladbach": "글라트바흐", "Eintracht Frankfurt": "프랑크푸르트", "SC Freiburg": "프라이부르크", "Heidenheim": "하이덴하임", "Hoffenheim": "호펜하임", "Holstein Kiel": "홀슈타인 킬", "RB Leipzig": "라이프치히", "FSV Mainz 05": "마인츠", "St. Pauli": "상파울루", "Stuttgart": "슈투트가르트", "Union Berlin": "우니온 베를린", "Werder Bremen": "브레멘", "Wolfsburg": "볼프스부르크",
  // 세리에 A
...
"Penafiel": "페나피엘", "Felgueiras": "펠게이라스", "Oliveirense": "올리베이렌세", "Leiria": "레이리아", "Galatasaray": "갈라타사라이", "Fenerbahce": "페네르바흐체", "Besiktas": "베식타시", "Trabzonspor": "트라브존스포르",
...
"Boluspor": "볼루스포르", "Bandirmaspor": "반드르마스포르", "Erzurumspor": "에르주룸스포르", "Manisa FK": "마니사 FK", "Ümraniyespor": "움라니예스포르", "Keçiörengücü": "케치외렌귀쥐", "Igdir FK": "이그디르 FK",
...
"Legia Warszawa": "레기아 바르샤바", "Lech Poznan": "레흐 포즈난", "Pogon Szczecin": "포곤 슈체친", "Rakow Czestochowa": "라쿠프 쳉스토호바", "Gornik Zabrze": "구르니크 자브제", "Stal Mielec": "스탈 미엘레츠",
...
"Lokomotiv Sofia": "로코모티브 소피아"
{
  ...
  "Belasitsa": "벨라시차",
  "Fratria": "프라트리아",
  "Lokomotiv G. Oryahovitsa": "로코모티브 고르나 오랴호비차",
  "Dobrudzha": "도브루자",
  "Botev Vratsa": "보테프 브라차",
  "Ludogorets II": "루도고레츠 2군",
  "FK Minyor Pernik": "미뇨르 페르니크",
  "Sportist Svoge": "스포르티스트 스보게",
  "CSKA Sofia II": "CSKA 소피아 2군",
  "Marek": "마레크",
  "Vihren": "비흐렌",

  "Zawisza Bydgoszcz": "자비샤 비드고슈치",
  "Miedz Legnica": "미에츠 레그니차",
  "Polonia Bytom": "폴로니아 비톰",
  "Arka Gdynia": "아르카 그디니아",
  "Chrobry Glogow": "크로브리 그워구프",
  "Ruch Chorzów": "루흐 호주프",
  "Pogon Grodzisk Mazowiecki": "포곤 그로지스크 마조비에츠키",
  "Korona Kielce": "코로나 키엘체",
  "Rakow Czestochowa": "라쿠프 체스토호바",
  ...
  "Schwarz-Weiß Bregenz": "슈바르츠바이스 브레겐츠",
  "Sturm Graz II": "슈투름 그라츠 2군",
  "SKN St. Polten": "장크트 푈텐",
  "Austria Klagenfurt": "아우스트리아 클라겐푸르트",
  "Admira Wacker": "아드미라 바커",
  "Stripfing": "슈트리핑",
  "SKU Amstetten": "암슈테텐",
  "Rapid Wien II": "라피드 빈 2군",
  "WSPG Wels": "벨스",
  "SV Kapfenberg": "카펜베르크",
  ...
  "Serik Spor": "세리크스포르",
  "Vanspor FK": "반스포르",
  "Kastamonuspor": "카스타모누스포르",
  "Karaman FK": "카라만 FK",
  "Ankaraspor": "앙카라스포르",
  "Batman Petrolspor": "배트맨 페트롤스포르",
  "Iskenderunspor": "이스켄데룬스포르",
  "24 Erzincanspor": "에르진잔스포르",
  "Beykoz Anadolu": "베이코즈 아나돌루",
  "Altinordu": "알튼오르두",
  "Bucaspor 1928": "부카스포르 1928",
  "Beyoglu Yeni Carsi": "베이욜루 예니 차르시",
  "Erbaaspor": "에르바스포르",
  "Adana 01 FK": "아다나 01 FK",
  "Kepezspor": "케페즈스포르",
  "Ankaragucu": "앙카라귀쥐",
  "Muglaspor": "무을라스포르",
  "Karacabey Belediyespor": "카라자베이 벨레디예스포르",
  "Igdir FK": "이디르 FK",
  "Basaksehir": "바샥셰히르",
  ...
  "Midland": "미들랜드",
  "Acassuso": "아카수소",
  "Independiente Medellin": "인데펜디엔테 메데진",
  ...
  "Estudiantes de Rio Cuarto": "에스투디안테스 리오쿠아르토",
  "San Martin Tucuman": "산마르틴 투쿠만",
