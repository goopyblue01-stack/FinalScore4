...
"Dalian Huayi": "다롄 화이", "Gimcheon Sangmu FC": "김천 상무", "Asan Mugunghwa": "아산 무궁화", "Gimhae City": "김해시청", "First Vienna": "퍼스트 비엔나", "Macarthur": "맥아서", "Pogoń Siedice": "포곤 시에들체",
...
"Wisla Krakow": "비스와 크라쿠프", "TSV Hartberg": "하르트베르크", "Padova": "파도바", "1. FC Köln": "쾰른", "Kasımpaşa": "카슴파샤", "KAA Gent Il": "헨트 2군", "Liège": "리에주", "Atletico Paranaense": "아틀레치쿠 파라나엔시",
...
"Yeni Mersin Idmanyurdu": "메르신", "Adanaspor": "아다나스포르", "Yeni Malatyaspor": "말라티아스포르", "Kirklarelispor": "키르클라렐리스포르"
 };
