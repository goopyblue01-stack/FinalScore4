...
"Gimnasia L.P.": "힘나시아", "Deportivo Camioneros": "카미오네로스", "Platense": "플라텐세", "Penarol": "페냐롤", "Lokeren-Temse": "로케런-템세", "Étoile Carouge": "에투알 카루주", "Yverdon Sport": "이버돈 스포르트",
...
"AD Ceuta FC": "AD 세우타", "AS Roma": "AS 로마", "1899 Hoffenheim": "호펜하임", "SKN ST. Polten": "장크트 푈텐", "Charleroi": "샤를루아", "St Patrick's Athl.": "세인트 패트릭스 애슬레틱", "Loudoun United": "라우던 유나이티드",
...
"FC St. Pauli": "장크트 파울리", "Budapest Honved": "부다페스트 혼베드", "Kozarmisleny FC": "코자르미슬레니", "Fenerbahçe": "페네르바흐체", "União de Leiria": "우니앙 레이리아", "Górnik Łęczna": "고르니크 렝치나",
...
"CF Montreal": "CF 몬트리올", "FC Thun": "툰", "FC Basel 1893": "바젤", "Almagro": "알마그로", "Patronato": "파트로나토", "San Miguel": "산 미겔", "Deportivo Moron": "데포르티보 모론", "San Telmo": "산 텔모",
"St. Truiden": "신트트라위던", "Remo": "레모", "Vasco DA Gama": "바스쿠 다 가마", "Detroit City": "디트로이트 시티", "Sporting JAX": "스포르팅 JAX", "Union Santa Fe": "우니온 산타페", "Ponte Preta": "폰치 프레타",
"Vila Nova": "빌라 노바", "Sport Recife": "스포르트 헤시피", "Avai": "아바이", "Colon Santa Fe": "콜론 산타페", "Racing Cordoba": "라싱 코르도바", "Santos": "산투스", "Atletico-MG": "아틀레치쿠 미네이루",
"Guadalajara Chivas": "과달라하라", "Brooklyn": "브루클린", "Charleston Battery": "찰스턴 배터리", "Hartford Athletic": "하트퍼드", "El Paso Locomotive": "엘파소 로코모티브", "SK Beveren": "베베런",
"Deportivo Riestra": "데포르티보 리에스트라", "SV Darmstadt 98": "다름슈타트", "Indy Eleven": "인디 일레븐", "Monterey Bay": "몬터레이 베이", "Lexington": "렉싱턴", "Rhode Island": "로드아일랜드", "Irapuato": "이라푸아토",
"Charlotte": "샬럿", "DC United": "DC 유나이티드", "Tampa Bay Rowdies": "탬파베이", "Oakland Roots": "오클랜드 루츠", "Ceara": "세아라", "Nautico Recife": "나우치쿠", "FC Tulsa": "털사", "Atlanta United FC": "애틀랜타 유나이티드",
"St. Louis City": "세인트루이스 시티", "Miami FC": "마이애미", "Barracas Central": "바라카스 센트랄", "Monarcas": "모나르카스", "Cancún": "칸쿤", "Atlante FC": "아틀란테", "Venados FC": "베나도스",
...
"Nara Club": "나라 클럽", "Kamatamare Sanuki": "가마타마레 사누키", "Kanazawa": "가나자와", "Imabari": "이마바리", "Kitakyushu": "기타큐슈", "Tegevajaro Miyazaki": "미야자키", "Gainare Tottori": "가이나레 돗토리",
"Biwako Shiga": "비와코 시가", "FC Ryukyu": "류큐", "Chuncheon": "춘천", "Gangneung City": "강릉시청", "Ulsan Citizen": "울산시민", "Jeonbuk Motors II": "전북 현대 2군", "Kashima": "가시마",
"Dalian Huayi": "다롄 화이", "Gimcheon Sangmu FC": "김천 상무", "Asan Mugunghwa": "아산 무궁화", "Gimhae City": "김해시청", "First Vienna": "퍼스트 비엔나", "Macarthur": "맥아서", "Pogoń Siedlce": "포곤 시에들체",
"Tychy 71": "티히", "Cracovia Krakow": "크라코비아", "Birmingham": "버밍엄", "Tianjin Teda": "톈진 TEDA", "Qingdao Jonoon": "칭다오 중넝", "VfL Bochum": "보훔", "FC Schalke 04": "샬케", "SC Paderborn 07": "파더보른",
"1. FC Magdeburg": "마그데부르크", "Fatih Karagümrük": "카라귐뤼크", "Heilongjiang Lava Spring": "헤이룽장", "Hebei Kungfu": "허베이 쿵푸", "Dongguan United": "둥관 유나이티드", "Chengdu Better City": "청두 룽청",
"Cultural Leonesa": "쿨투랄 레오네사", "Sanlıurfaspor": "샨리우르파스포르", "Altınordu": "알튼오르두", "Ankara Demirspor": "앙카라 데미르스포르", "Bursaspor": "부르사스포르", "Somaspor": "소마스포르",
"68 Aksaray Belediyespor": "악사라이", "1461 Trabzon FK": "트라브존 1461", "Isparta 32 Spor": "이스파르타", "Güzide Gebzespor": "게브제스포르", "Fethiyespor": "페티예스포르", "Aliağa FAŞ": "알리아아",
