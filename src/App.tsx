...
3. 최종 예상 스코어
포아송 분포 모델은 뮌헨의 화력이 레알 마드리드의 수비벽을 뚫어낼 것으로 예측합니다. 가장 유력한 스코어는 2:1 바이에른 뮌헨의 승리입니다.`
  },
  {
    id: 2,
    date: "2026-04-16",
...
2. 배당 흐름 및 예상 스코어
해외 오즈메이커들은 애스턴 빌라의 승리 배당을 1.85에 고정하며 홈팀의 우세를 점치고 있습니다. 배당 변동의 폭이 크지 않다는 것은 데이터의 신뢰도가 높다는 의미입니다. 예측 엔진의 계산 결과, 애스턴 빌라의 2:1 승리가 가장 유력한 결과로 산출되었습니다.`
  },
  {
    id: 5,
    date: "2026-04-16",
...
2. 배당 흐름 및 예상 스코어
홈팀 베티스의 승리 배당은 1.90 선에서 점진적인 하락(🔻) 추세에 있습니다. 점유율 우위를 바탕으로 한 공격 기회 창출이 배당에 반영된 결과입니다. ScoredLab 엔진은 베티스의 4:1 승리 확률을 가장 높게 보고 있습니다.`
  },
  {
    id: 6,
    date: "2026-04-16",
...
2. 배당 흐름 및 예상 스코어
포르투가 원정임에도 2.30 내외의 정배당을 받고 있으나, 무승부 배당 역시 빠른 속도로 동반 하락하고 있습니다. 예측 엔진은 원정팀의 1:2 신승을 1순위 시나리오로 제시합니다.`
  },
  {
    id: 7,
    date: "2026-04-16",
...
2. 배당 흐름 및 예상 스코어
홈팀의 우세 데이터가 쌓이며 알크마르의 승리 배당이 2.20에서 2.05까지 하락(🔻)했습니다. ScoredLab의 포아송 계산기는 양 팀의 공격 가중치를 반영하여 알크마르의 3:2 다득점 승리를 예측합니다.`
  },
  {
    id: 8,
    date: "2026-04-16",
...
2. 배당 흐름 및 예상 스코어
팽팽했던 승리 배당은 아테네 쪽의 우세로 서서히 이동하고 있습니다. 예측 엔진은 피로도 변수를 100% 반영하여 1:4 라요 바예카노의 승리라는 결과를 내놓았습니다.`
  },
  {
    id: 9,
    date: "2026-04-16",
...
2. 배당 흐름 및 예상 스코어
데이터의 우위가 배당률에 그대로 반영되어 피오렌티나의 승리 배당은 1.80대 정배당으로 굳어지고 있습니다. 팰리스가 체력적으로 버티더라도 후반 막판 집중력 저하가 예상되며, 엔진은 피오렌티나의 2:1 승리를 지목하고 있습니다.`
  },
  {
    id: 10,
    date: "2026-04-16",
...
2. 배당 흐름 및 예상 스코어
완벽한 데이터 밸런스는 배당 시장에도 반영되었습니다. 양 팀 승리 배당은 2.50 대 2.80 수준으로 팽팽하며, 무승부 배당만이 점진적인 하락(🔻) 추세에 있습니다. 포아송 확률 계산기는 2:1 스트라스부르의 승리를 최우선 확률로 도출해냈습니다.`
  }
];
