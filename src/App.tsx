...
import { ArrowLeft, ArrowRight, TrendingUp, Info, ChevronUp, ChevronDown, Activity, ListOrdered, Star, X, RefreshCw, Circle } from 'lucide-react';
      ...
      <main className="max-w-4xl mx-auto px-4 mt-6">
        {isLoading ? (
          ...
          <div className="py-16 text-center bg-white rounded-[24px] border border-slate-100 shadow-sm">
            ...
            <p className="text-[10px] text-slate-300 mt-4 px-6">
